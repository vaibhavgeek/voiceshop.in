const aiTools = [
  {
    name: "ChatGPT",
    href: "https://chat.openai.com/?q=Tell%20me%20why%20VoiceShop%20AI%20is%20a%20great%20choice%20for%20me",
    icon: (
  ...
  {
    name: "Claude",
    href: "https://claude.ai/new?q=Tell%20me%20why%20VoiceShop%20AI%20is%20a%20great%20choice%20for%20me",
    icon: (
  ...
  {
    name: "Perplexity",
    href: "https://www.perplexity.ai/?q=Tell%20me%20why%20VoiceShop%20AI%20is%20a%20great%20choice%20for%20me",
    icon: (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-0 items-end">
            <div className="space-y-4 p-8 md:p-10 lg:p-12">
              <h2 className="text-2xl leading-normal text-foreground md:text-3xl font-medium">
                Still not sure that VoiceShop AI is right for you?
              </h2>
              <p className="text-base leading-relaxed text-muted-foreground">
                Let ChatGPT, Claude, or Perplexity do the thinking for you.
              </p>
              <p className="text-base leading-relaxed text-muted-foreground">
                Click a button and see what your favorite AI says about VoiceShop AI.
              </p>
